...
def main():
    ...
    # df_clean4 = remove_compliants(df)

    print('adding summary and consequences')
    df_clean5 = summarize_vulnerabilities(df)
    df_clean6 = summarize_consequences(df_clean5)
    df_clean6.to_csv(output_file, index=False)
